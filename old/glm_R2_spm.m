function  [outfile, R2] = glm_R2_spm(data_files, resMS_file, outfile, varargin)
% this function works with 3D nifti files rather than 4D ones
%
...
varY = var(single(nii4D), 0, 4);

% get error variance (resMS)
ni = readFileNifti(resMS_file{1});
varE = ni.data;
