...
for ses=1:numel(matlabbatch{1}.spm.spatial.realign.estwrite.data)
    matlabbatch{5}.spm.stats.fmri_spec.sess(ses).scans(1) = cfg_dep('File Set Split: first_TR (rem)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('{}',{2}));
